...
#
# Задание 5.
# Перед вами ряд значений уровней значимости, которые были получены в результате множественного сравнения выборок с помощью t-критерия. Сколько из них говорят о достоверных различиях, если в качестве порога достоверности взят уровень значимости 0.05?
###############
...
# Задание 7. Постройте линейную модель, описывающую зависимость роста от возраста и пола с учетом взаимодействия между этими предикторами (на основе датафрейма fev)
