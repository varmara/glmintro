#### Упражнение по подбору линейной модели c дискретным и непрерывным предиктором, без взаимодействия #########
...
# Видно, что линии предсказанных значений идут
# параллельно. Но, чтобы иметь право применять
# этот анализ, нужно протестировать необходимость
