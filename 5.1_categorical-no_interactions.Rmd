...
- Если в фокусе нашего внимания влияние дискретного предиктора, но это влияние зависит от дополнительной перменной - _ковариаты_ (такой анализ называется ANCOVA)
...
$$
$I$ - это перменные-селекторы (dummy variable)
