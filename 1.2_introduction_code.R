...
#' ### Как давать имена?
#' 
#' только латинские буквы, цифры, нижнее подчеркивание и точку.
#' 
...
#' 
#' - Команда `seq` создает вектор, где значения следуют одно за другим
#' 
...
#' Аргумент `header` определяет судьбу названий столбцов. Чтобы названия были прочитаны и стали именами переменных, нужно указать TRUE.
#' 
...
#' 
#' ## Фрагмент таблицы данных с помощью команды 'subset'
#' 
