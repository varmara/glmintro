...
Вне зависимости от нас, реальность может находиться в одном из двух состояний:  $H_0$ верна, ящерицы одинаковы, либо $H_0$ неверна, и ящерицы различаются.
...
Вероятность ошибки I рода мы задаем сами --- это уровень значимости теста, $\alpha$. Это та вероятность, меньше которой мы отказываемся верить в справедливость $H_0$.
...
P-value отражает вероятность обнаружить тот уровень различий между выборками который мы видим, при условии что $H_0$ верна.
...
P-value = 0.03 не значит, что $H_0$ верна с вероятностью 3%!

P-value = 0.03 значит, что в мире, где выборки одинаковы а $H_0$ верна, шанс получить результат который мы получили составляет 3%.
...
Это вероятность того, что в мире, где $H_0$ верна, а длины ящериц из Берлина и Саратова равны, шанс получить эмпирические выборки с такими различиями как у нас, составляет 0.2%.
