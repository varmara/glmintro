...
## В какой из выборок разброс максимален? В какой минимален?

```{r sd_compare1, echo=FALSE, purl=FALSE, fig.width=5.5, fig.height = 5, warning=FALSE, message=FALSE}
set.seed(999)
y1 <- rnorm(500, 10, 4)
y2 <- rnorm(500, 10, 1)
...
```{r sd_compare2, echo=FALSE, purl=FALSE, fig.width=5.5, fig.height = 5, warning=FALSE, message=FALSE}

gy1a <- ggplot(sd_compare, aes(x = y1)) +geom_histogram(fill="steelblue", color = "grey20") +  geom_vline (xintercept = 10, color = "red", linetype = "dashed", size - 1.5) + scale_x_continuous(limits=c(0,20)) + labs(x = round(sd(y1),2))

gy2a <- ggplot(sd_compare, aes(x = y2)) +geom_histogram(fill="steelblue", color = "grey20") +  geom_vline (xintercept = 10, color = "red", linetype = "dashed", size - 1.5) + scale_x_continuous(limits=c(0,20))  + labs(x = round(sd(y2),2))
...
gy4a <- ggplot(sd_compare, aes(x = y4)) + geom_histogram(fill="steelblue", color = "grey20") +  geom_vline (xintercept = 10, color = "red", linetype = "dashed", size - 1.5) + scale_x_continuous(limits=c(0,20))  + labs(x = round(sd(y4),2))

gy5a <- ggplot(sd_compare, aes(x = y5)) + geom_histogram(fill="steelblue", color = "grey20") +  geom_vline (xintercept = mean(y5), color = "red", linetype = "dashed", size - 1.5) + scale_x_continuous(limits=c(0,20))  + labs(x = round(sd(y5),2))

gy6a <- ggplot(sd_compare, aes(x = y6)) + geom_histogram(fill="steelblue", color = "grey20") +  geom_vline (xintercept = 10, color = "red", linetype = "dashed", size - 1.5) + scale_x_continuous(limits=c(0,20))  + labs(x = round(sd(y6),2))
