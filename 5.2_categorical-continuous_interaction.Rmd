...
```{r MG1-residuals, fig.show='hold', fig.height=3, fig.width=10, purl=FALSE}
set.seed(9827)
...
```{r MG2-residuals, fig.show='hold', fig.height=3.5, fig.width=10, purl=FALSE}
set.seed(849)
...
```{r gg-MG2-residual-plots, eval=TRUE, echo=FALSE, purl=FALSE, fig.width=10}
grid.arrange(
gg_res %+% aes(x = init),
gg_res %+% aes(x = treat) + geom_boxplot(),
nrow = 1)
